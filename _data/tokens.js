...
window.JELLYROLL_TOKENS = {
  ...
  "preview/components-slider.html": [
    { name: "--sl-blue-600",       value: "#0841B4", role: "Filled track + thumb" },
    { name: "--sl-blue-200",       value: "#CED9F0", role: "Unfilled track" },
    { name: "--sl-red-600",        value: "#E31C3D", role: "Error fill + thumb" },
    { name: "--sl-red-200",        value: "#F9D2D8", role: "Error unfilled track" },
    { name: "--sl-grey-400",       value: "#C4CAD6", role: "Disabled fill + thumb" },
    { name: "--sl-grey-200",       value: "#EBEDF1", role: "Disabled track" },
    { name: "--sl-white",          value: "#FFFFFF", role: "Thumb inner border (2px)" },
    { name: "--color-text-body",   value: "#131C35", role: "Label and value readout" },
    { name: "--color-text-subtle", value: "#7D8695", role: "Min\u2013max range caption, help text" },
    { name: "--color-text-alert",  value: "#B61631", role: "Error help text" },
    { name: "--field-border-default", value: "#C4CAD6", role: "Paired number input border" },
    { name: "--field-radius",      value: "4px",     role: "Paired number input radius" },
    { name: "--font-mono",         value: "ui-monospace, 'SF Mono', Menlo, Consolas, monospace", role: "Value readout and range caption" },
  ],
