      ...
      items: [
        ...
        },
        {
          ...
          meta: {
            ...
            options: "Widths: fluid (default), sm 160px, md 240px, lg 320px. Value display: none, read-only readout, or a paired Number input sized off `--digits` so the field is never wider than the slider's longest legal value. Optional label, min–max range caption, unit suffix, and help text. No tick marks, value bubble, vertical orientation, or dual-thumb range in the base component.",
