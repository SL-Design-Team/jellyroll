      ...
      items: [
        {
          ...
          meta: {
            anatomy: "Avatars overlap by 8px at the default size in left-to-right DOM and visual order. Overflow is a grey `+N` button at the right edge. A presence status dot sits at each avatar's bottom-right — Green-600 for active, Grey-500 for inactive — ringed in the surface color. Active is the default; inactive avatars are also neutral on light surfaces and dimmed on the dark global header.",
